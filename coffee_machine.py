    ...
    def order(self):
        ...
        while not is_off:
            ...
            if choice in self.mapping:
                ...
                if choice.upper() == "N": # Second choice is not in the menu.
                    ...
                    if sec_choice in self.mapping:
                        price += int(self.mapping[sec_choice])  # Calculates new price of the product.
                        payment = self.process_payment(price)
                        if payment >= price:  # If enough money, make coffee.
                            self.make_coffee()
                            is_off = True
                else:
                    print("Your choice is incorrect please run the program again")
